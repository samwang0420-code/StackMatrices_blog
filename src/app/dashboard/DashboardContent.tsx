...
const API_BASE =
  process.env.NEXT_PUBLIC_API_URL || "https://api.stackmatrices.com";
        ...
        <div className="grid grid-cols-3 gap-4 text-sm">
          ...
          <div>
            <span className="text-slate-500">
              {license.type === "credits" ? "Credits Used" : "Expires"}
            </span>
            <div className="text-white mt-1">
              {license.type === "credits"
      ...
      <div className="p-6 bg-slate-950/50">
        <div className="flex items-center justify-between mb-4">
          ...
          >
            ...
            <ChevronRight
              className={`w-3 h-3 transition-transform ${showSetup ? "rotate-90" : ""}`}
            />
          </button>
        </div>
        ...
        <div className="mt-3 text-xs text-slate-500 text-center">
          ...
          <span className="text-slate-400">
            Download and double-click run.bat (Windows) or run.sh (Mac/Linux)
          </span>
        </div>
      </div>
    </div>
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    if (success === "true") {
      setToast(
        `Payment Successful! ${skillName ? `${skillName} is` : "Your skill is"} ready for deployment below.`,
      );
      // Clean URL
      ...
      <div className="min-h-screen bg-slate-950 flex items-center justify-center">
        <div className="text-center">
          <p className="text-slate-400 mb-4">
            Please login to access your Command Center
          </p>
          <Link
            href="/login"
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-400">
            Deploy and manage your StackMatrices skills
          </p>
        </div>
        ...
        {licenses.length > 0 && (
          <div className="mt-8 p-6 bg-gradient-to-r from-emerald-900/20 to-slate-900 border border-emerald-500/20 rounded-xl">
            ...
            <p className="text-slate-300 text-sm">
              Copy the install command above and paste it in your terminal. The
              skill will automatically configure itself and prompt you for any
              required API keys.
            </p>
          </div>
        )}
