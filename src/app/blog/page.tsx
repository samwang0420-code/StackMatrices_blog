...
const BLOG_POSTS = [
  ...
  },
  {
    ...
    featured: false,
    image: BLOG_IMAGES["entity-seo-medical-practices"],
  },
  {
    ...
    readTime: "8 min read",
    featured: true,
    image: BLOG_IMAGES["quality-guidelines"],
  },
  {
  ...
  },
  {
    ...
    excerpt: "Step-by-step implementation guide for MedicalOrganization, Physician, and Procedure schema. Includes code examples and validation tools.",
    category: "Implementation",
    author: "Michael Torres",
    date: "March 5, 2026",
    readTime: "18 min read",
    featured: false,
    image: BLOG_IMAGES["schema-markup-guide"],
  },
  {
    id: "predictions-2026",
    title: "2026 Medical Marketing Predictions: The Year of AI-First Patient Acquisition",
    excerpt: "Five key predictions that will reshape medical marketing in 2026. From Google SGE dominance to regulatory changes, prepare your practice now.",
    category: "Industry Trends",
    author: "Sam Wang",
    date: "March 4, 2026",
    readTime: "10 min read",
    featured: false,
    image: BLOG_IMAGES["predictions-2026"],
  },
  {
    id: "ai-optimized-content",
    title: "How to Write AI-Optimized Content That Gets Cited by ChatGPT",
    excerpt: "The 5-paragraph framework for creating content that AI systems cite. Learn the anatomy of AI-referenced medical content with real examples.",
    category: "Content Strategy",
    author: "Sarah Kim",
    date: "March 3, 2026",
    readTime: "12 min read",
    featured: false,
    image: BLOG_IMAGES["ai-optimized-content"],
  },
];
