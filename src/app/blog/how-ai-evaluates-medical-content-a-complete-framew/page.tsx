    ...
    <div className="min-h-screen bg-gradient-to-br from-navy via-navy-light to-navy-dark text-white py-16 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <article className="prose prose-invert max-w-none">
          ...
          <h2>How AI systems understand medical content</h2>
          <p>
            Content about how ai systems understand medical content. This section covers the key aspects that medical practices 
            need to understand about this topic and how it impacts their GEO strategy.
          </p>

          <h2>Entity vs keyword-based indexing</h2>
          <p>
            Content about entity vs keyword-based indexing. This section covers the key aspects that medical practices 
            need to understand about this topic and how it impacts their GEO strategy.
          </p>

          <h2>Trust signals that matter</h2>
          <p>
            Content about trust signals that matter. This section covers the key aspects that medical practices 
            need to understand about this topic and how it impacts their GEO strategy.
          </p>

          <h2>Building topical authority</h2>
          <p>
            Content about building topical authority. This section covers the key aspects that medical practices 
            need to understand about this topic and how it impacts their GEO strategy.
          </p>

          <h2>Technical implementation</h2>
          <p>
            Content about technical implementation. This section covers the key aspects that medical practices 
            need to understand about this topic and how it impacts their GEO strategy.
          </p>
